        ...
        <tbody>
            <?php foreach ($feedbacks as $feedback): ?>
                <tr>
                    ...
                    <td>
                        <!-- Delete Button -->
                        <a href="delete_feedback.php?id=<?php echo $feedback['Id']; ?>" onclick="return confirm('Are you sure you want to delete this feedback?')">
...
<script>
    ...
    function filterRatings() {
        ...
        if (filteredRatings.length > 0) {
            ...
            ratingsTable.innerHTML = "<tr><td colspan='4' class='no-data'>No data available for selected filters.</td></tr>";
        }
    }
</script>
